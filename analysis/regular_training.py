...
run_notes = "Run 13, 500k hyper_tunning based on 10254514-23, jewel. Higher epsilon, max_attempts to 1, and multiple svm_nu, min_epoch to 40."  # Small command on run, will be save to save file.
